...
use jcode_shell_minimizer::{self, MinimizerConfig, engine::MIN_MINIMIZE_CHARS};
...
fn check_fixture(fixture: &Fixture, cfg: &MinimizerConfig) -> Result<(), String> {
	let out = jcode_shell_minimizer::apply(&fixture.command, &fixture.raw, fixture.exit, cfg);
